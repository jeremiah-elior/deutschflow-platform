...
function snakePatch(input: Record<string, any>, map: Record<string, string>) {
  ...
  for (const [from, to] of Object.entries(map)) {
    if (Object.prototype.hasOwnProperty.call(input, from)) output[to] = input[from];
  }
  return output;
}

async function one<T = any>(request: any, code: string): Promise<T> {
  const { data, error } = await request.select().single();
  if (error) throw new HttpError(500, code, error.message);
  return data;
}

async function deleted(request: any, code: string) {
...
export async function listAdminContentOptions() {
  ...
  if (langError) throw new HttpError(500, 'languages_options_failed', langError.message);
  if (courseError) throw new HttpError(500, 'courses_options_failed', courseError.message);
  if (chapterError) throw new HttpError(500, 'chapters_options_failed', chapterError.message);
  if (categoryError) throw new HttpError(500, 'categories_options_failed', categoryError.message);
  if (seriesError) throw new HttpError(500, 'series_options_failed', seriesError.message);
...
export async function updateCourse(id: string, input: z.infer<typeof CoursePatchInput>) {
...
export async function deleteCourse(id: string) { return deleted(supabaseAdmin.from('courses').delete().eq('id', id), 'course_delete_failed'); }

export async function updateLevel(id: string, input: z.infer<typeof LevelPatchInput>) {
...
export async function deleteLevel(id: string) { return deleted(supabaseAdmin.from('course_levels').delete().eq('id', id), 'level_delete_failed'); }

export async function updateChapter(id: string, input: z.infer<typeof ChapterPatchInput>) {
...
export async function deleteChapter(id: string) { return deleted(supabaseAdmin.from('chapters').delete().eq('id', id), 'chapter_delete_failed'); }
...
export async function updateCategory(id: string, input: z.infer<typeof CategoryPatchInput>) {
...
export async function deleteCategory(id: string) { return deleted(supabaseAdmin.from('course_categories').delete().eq('id', id), 'category_delete_failed'); }
...
export async function updateSeries(id: string, input: z.infer<typeof SeriesPatchInput>) {
...
export async function deleteSeries(id: string) { return deleted(supabaseAdmin.from('course_series').delete().eq('id', id), 'series_delete_failed'); }
...
export async function updateVocabulary(id: string, input: z.infer<typeof VocabularyPatchInput>) {
...
export async function deleteVocabulary(id: string) { return deleted(supabaseAdmin.from('chapter_vocabulary').delete().eq('id', id), 'vocabulary_delete_failed'); }
...
export async function updateNote(id: string, input: z.infer<typeof NotePatchInput>) {
...
export async function deleteNote(id: string) { return deleted(supabaseAdmin.from('chapter_notes').delete().eq('id', id), 'note_delete_failed'); }
...
export async function updateVideo(id: string, input: z.infer<typeof VideoPatchInput>) {
...
export async function deleteVideo(id: string) { return deleted(supabaseAdmin.from('chapter_videos').delete().eq('id', id), 'video_delete_failed'); }
...
export async function updateQuiz(id: string, input: z.infer<typeof QuizPatchInput>) {
...
export async function deleteQuiz(id: string) { return deleted(supabaseAdmin.from('chapter_quiz_questions').delete().eq('id', id), 'quiz_delete_failed'); }

export async function listChapterAssets(query: { chapterId?: string; language?: string; assetType?: string }) {
  ...
  if (error) throw new HttpError(500, 'chapter_assets_fetch_failed', error.message);
...
export async function updateChapterAsset(id: string, input: z.infer<typeof AssetPatchInput>) {
  ...
  if (payload.storage_path && !payload.public_url) payload.public_url = publicUrl(payload.storage_path);
  return one(supabaseAdmin.from('chapter_assets').update(payload).eq('id', id), 'chapter_asset_update_failed');
}
export async function deleteChapterAsset(id: string) { return deleted(supabaseAdmin.from('chapter_assets').delete().eq('id', id), 'chapter_asset_delete_failed'); }
